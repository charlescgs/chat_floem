...
//     let room_view = Vector::from(vec!["asdasd".to_string(), "tertrte".to_string(), "werweewg".to_string(), "ertrtrtret".to_string(), "rtwertertwe".to_string(), "werwerwerwer".to_string(), "etwerrtwerwer".to_string(), "tyutyutyth".to_string(), "yujkhngcvb".to_string(), "gZsdczsxcasc".to_string()]);
//     let room_view = create_rw_signal(room_view);

//     let mut selected_room = create_rw_signal(String::new());
    
//     let room_msgs = Vector::from(vec![
//         "asdsdsdasda Msg_autor".to_string(), "tertrte Msg_autor".to_string(), "1F600 Msg_autor".to_string(), "U+1F600 Msg_autor".to_string(), "rtwertertwe Msg_autor".to_string(), "werwerwerwer Msg_autor".to_string(), "etwerrtwerwer Msg_autor".to_string(), "tyutyutyth Msg_autor".to_string(), "yujkhngcvb Msg_autor".to_string(), "gZsdczsxcasc Msg_autor".to_string(),
